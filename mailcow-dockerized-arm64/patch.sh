...
awk '{sub("mailcow/backup","backup:latest"); print}' ${MAILCOW_INSTALL_DIR}/helper-scripts/backup_and_restore.original.sh > ${MAILCOW_INSTALL_DIR}/helper-scripts/backup_and_restore.sh
